...
# ──────────────────────────────────────────────
# DynamoDB (Users & Organizations for RBAC)
# ──────────────────────────────────────────────

resource "aws_dynamodb_table" "users" {
  name         = "${var.project_prefix}_users"
  billing_mode = "PAY_PER_REQUEST"
  hash_key     = "user_id"
...
resource "aws_dynamodb_table" "organizations" {
  name         = "${var.project_prefix}_organizations"
  billing_mode = "PAY_PER_REQUEST"
  hash_key     = "org_id"
...
# ──────────────────────────────────────────────
# Cognito (Auth & RBAC Identity Provider)
# ──────────────────────────────────────────────

resource "aws_cognito_user_pool" "pool" {
  name = "${var.project_prefix}_user_pool"
...
resource "aws_cognito_user_pool_client" "client" {
  name         = "${var.project_prefix}_app_client"
